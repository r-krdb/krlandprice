...
#reorder
land2017_raw <- land2017_raw[,c("일련번호","시도명","시군구","시군구명","읍면","동리","읍면동리","본번지","부번지","지리적위치1","지리적위치2","지목","지번","지번구분","지세명","형상명","도로교통","면적","용도지역1","용도지역2","이용상황","주위환경","공시지가")]
land2016_raw <- land2016_raw[,c("일련번호","시도명","시군구","시군구명","읍면","동리","읍면동리","본번지","부번지","지리적위치1","지리적위치2","지목","지번","지번구분","지세명","형상명","도로교통","면적","용도지역1","용도지역2","이용상황","주위환경","공시지가")]
